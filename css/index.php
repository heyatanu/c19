...
<body>
  ...
  <div class="modal fade" id="myModalload" role="dialog">
    ...
    font-family: monospace; font-size:20px;">
        <span>&#10146;</span>      
if the data is not showing then refresh the page please <br>
...
<ul class="nav nav-tabs nav-justified">
    <li class="nav-item ">
      <a class="nav-link  active-for-dark-mode" href="index.php" target="-blank">Quick View</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="others/indiatable.php" target="-blank">India Data In Details </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="others/globletable.php" target="-blank">World Wide Data In Details </a>
    </li>
    
    <li class="nav-item">
      <a class="nav-link " href="others/rescorce.html" target="-blank">Rescorces</a>
    </li>
  </ul>
    <!--NAV BAR END HERE -->
    ...
    <div class=".main"><!--THIS IS THE MAIN DIV OF THIS PAGE-->
        ...
        <div class="mainheading">
            <div class="mainheading-text">
                ...
                <div class="darkmodediv">
                    <img src="images/moon.png" width="6%" id="dark" alt="dark" onclick="darkmode();">            
                    <img src="images/sun.png" width="7%" id="sun" alt="light" onclick="lightmode();">            
                </div>
        ...
        <div class="chatbot-container">
            ...
            <div class=" text-center chatbot-button ">
                                    <div class="container">
                        <button data-aos="zoom-in" data-toggle="modal" data-target="#myModal" id="myBtn"></button>
       ...
       <div class="showdatatitle"><p class="text-center">Have Any Problam ?? Contact Us</p></div>
		...
		<form action="mail_handler.php" method="post" name="form" class="form-box" id="contact-form">
			...
			<input type="text"data-aos="slide-up" name="name" class="form-control form-back" placeholder="Enter Your Full Name...." required><br>
			<label for="email"></label><br>
			<input type="email"data-aos="slide-up" name="email" class="form-control form-back" placeholder="Enter Your Email..." required><br>
			<label for="phone"></label><br>
			<input type="tel"data-aos="slide-up" name="phone" class="form-control form-back" placeholder="Where From You(Pincode)" required><br>
			<label for="message"></label><br>
			<textarea name="msg"data-aos="slide-up" class="form-control form-back" placeholder="Tell Us Your Problam..." required></textarea><br>
			<input type="submit" data-aos="slide-up"name="submit" value="Send" class="form-control submit btn btn-outline-success">
    ...
    <p style="font-size:25px; font-weight:600;" class="text-center" >We Stand With Everyone Fighting On The Frontline</p>
        ...
        <!--FOOTER START HERE-->
        <p id="footer">Created By <a href="https://m.facebook.com/atanu.dutta.735?ref=bookmarks">Atanu Dutta</a> </p>
